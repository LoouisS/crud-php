    ...
    <table border="1">
        ...
        <?php
            ...
            foreach ($lugar as $l) {
                ...
                echo "<td><a href='proceso.php?accion=modificar&ip=" . $l['ip'] . "&lugar=" . $l['lugar'] . "&descripcion=" . $l['descripcion'] . "'>Modificar</a></td>";
                echo "<td><a href='proceso.php?accion=borrar&ip=" . $l['ip'] . "'>Borrar</a></td>";
                echo "</tr>";
            }
        ?>
    </table>
